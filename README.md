...
* sudo nmap -v -sS -sV -Pn -A -oN nmap\_scan ip\_addr
...
* File / directory discovery (note sometimes you also want to dirbust more than just the web root ie dirbusting against http://site/login.php/FUZZ)
    ...
    * gobuster dir -u [https://example.com](https://example.com) -w /wordlists/Discovery/Web-Content/raft-large-directories.txt -t 30
    * gobuster dir -u [https://example.com](https://example.com) -w /wordlists/Discovery/Web-Content/raft-large-files.txt -t 30
