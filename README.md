...
* File / directory discovery
	*  wfuzz -c -z file,/usr/share/seclists/Discovery/Web-Content/raft-medium-directories.txt --hc 301,404,403 http://site/FUZZ (or use raft-medium-files.txt)
	* dirsearch -w /usr/share/seclists/Discovery/Web-Content/raft-medium-directories.txt -u URL --full-url (add -e extension such as -e php for specific extension targeting) (or use raft-medium-files.txt)
